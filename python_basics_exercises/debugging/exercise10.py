...
# string of digits as an argument and returns the product of all the digits in the string.
...
def digit_product(str_num):
    ...
    product = 0 # => Multiplying by 0 each time
...
# The answer is changing product to 1
def digit_product(str_num):
    digits = [int(n) for n in str_num]
    product = 1
