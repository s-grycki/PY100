...
print({1, 2, 3} in {1, 2, 3})           # => False ({1,2,3} not element in set)
print({3, 2} in {1, frozenset({2, 3})}) # => True (sets/frozensets same values)

# in != is. in checks for value equality. is checks object equality
